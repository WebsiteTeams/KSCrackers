...
export const DEFAULT_PRODUCTS: IProduct[] = [
  ...
  {
    name: "Sky Shot Rocket (Multi-Color)",
  ...
  {
    name: "Spinning Wheel Ground Chakkar",
  ...
  {
    name: "Shubh Deepawali Gift Box (31 Items)",
  ...
  {
    name: "Magic Whip & Crackling Sparks",
